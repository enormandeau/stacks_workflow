...
ENZYME1=$1 # Name of the enzyme (run 'process_radtags' without options for list)
ENZYME2=$2 # Name of the enzyme (run 'process_radtags' without options for list)

# Write command to file
echo -e "process_radtags commande used:\n\n\
    $(echo process_radtags_2_enzymes.sh $ENZYME1 $ENZYME2)" \
...
do
    ...
    cp 03-samples/$f/process_radtags.log 98-log_files/"$TIMESTAMP"_02_process_radtags_2_enzymes_"$f".log
done
