...
# IMPORTANT: make sure your read available options for populations in the papers and
# comment in/out options required to run your analysis
...
populations $b $P $M $r $m $g $V $B $W $s $e $t $v $h \
    ...
    $verbose $log_fst_comp 2>&1 | tee stacks_4_populations.log
