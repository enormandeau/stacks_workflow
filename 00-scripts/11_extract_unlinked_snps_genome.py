...
Where:
    ...
    diff_threshold: minimum difference between 0.0 and 1.0 to keep a second
      ...
      permissive and will keep a few false positives, ie: SNPs with low MAFs
      that have exactly the same information but where some one or a few
      samples were mis-genotyped. A value of 0.5 will get you 99.9% of what
      that is different without false positives. Values above 0.5 will lose you
      true positives.
