...
duplicated =    "#FF000088" # red
diverged =      "#0000FF88" # blue
...
# High Fis
d$Color[d$Fis > 0.85] = lowconf

# Too many heterozygotes
d$Color[d$PropHet > 0.6] = duplicated
...
# No heterozygotes at all
d$Color[d$MedRatio < 0.01] = diverged
